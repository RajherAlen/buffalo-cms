...
export const enum_pages_blocks_custom_block_columns_size = pgEnum(
  'enum_pages_blocks_custom_block_columns_size',
  ['oneThird', 'half', 'twoThirds', 'full'],
)
export const enum_pages_blocks_custom_block_planning_cards_button_variant = pgEnum(
  'enum_pages_blocks_custom_block_planning_cards_button_variant',
  ['primary', 'primary-outline', 'default', 'outline'],
)
export const card_bg = pgEnum('card_bg', ['default', 'floral'])
export const enum_pages_blocks_custom_block_contact_links_link_variant = pgEnum(
  'enum_pages_blocks_custom_block_contact_links_link_variant',
  ['default', 'outline'],
)
...
export const enum_pages_blocks_custom_block_planning_layout = pgEnum(
  'enum_pages_blocks_custom_block_planning_layout',
  ['default', 'floral'],
)
export const enum_pages_blocks_custom_block_burial_layout = pgEnum(
  'enum_pages_blocks_custom_block_burial_layout',
  ['vertical', 'horizontal'],
)
export const enum_pages_blocks_custom_block_benefit_layout = pgEnum(
  'enum_pages_blocks_custom_block_benefit_layout',
  ['vertical', 'horizontal'],
)
...
export const enum__pages_v_blocks_custom_block_columns_size = pgEnum(
  'enum__pages_v_blocks_custom_block_columns_size',
  ['oneThird', 'half', 'twoThirds', 'full'],
)
export const enum__pages_v_blocks_custom_block_planning_cards_button_variant = pgEnum(
  'enum__pages_v_blocks_custom_block_planning_cards_button_variant',
  ['primary', 'primary-outline', 'default', 'outline'],
)
export const enum__pages_v_blocks_custom_block_contact_links_link_variant = pgEnum(
  'enum__pages_v_blocks_custom_block_contact_links_link_variant',
  ['default', 'outline'],
)
...
export const enum__pages_v_blocks_custom_block_planning_layout = pgEnum(
  'enum__pages_v_blocks_custom_block_planning_layout',
  ['default', 'floral'],
)
export const enum__pages_v_blocks_custom_block_burial_layout = pgEnum(
  'enum__pages_v_blocks_custom_block_burial_layout',
  ['vertical', 'horizontal'],
)
export const enum__pages_v_blocks_custom_block_benefit_layout = pgEnum(
  'enum__pages_v_blocks_custom_block_benefit_layout',
  ['vertical', 'horizontal'],
)
...
export const pages_blocks_custom_block_columns = pgTable(
  'pages_blocks_custom_block_columns',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    size: enum_pages_blocks_custom_block_columns_size('size').default('oneThird'),
    richText: jsonb('rich_text'),
    enableLink: boolean('enable_link'),
  },
  (columns) => [
    index('pages_blocks_custom_block_columns_order_idx').on(columns._order),
    index('pages_blocks_custom_block_columns_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_columns_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_planning_cards_badges = pgTable(
  'pages_blocks_custom_block_planning_cards_badges',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('pages_blocks_custom_block_planning_cards_badges_order_idx').on(columns._order),
    index('pages_blocks_custom_block_planning_cards_badges_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block_planning_cards.id],
      name: 'pages_blocks_custom_block_planning_cards_badges_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_planning_cards = pgTable(
  'pages_blocks_custom_block_planning_cards',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    ...
    buttonVariant:
      enum_pages_blocks_custom_block_planning_cards_button_variant('button_variant').default(
        'default',
      ),
    cardBackground: card_bg('card_background').default('default'),
  },
  (columns) => [
    index('pages_blocks_custom_block_planning_cards_order_idx').on(columns._order),
    index('pages_blocks_custom_block_planning_cards_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_planning_cards_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_burial_options_burial_badges = pgTable(
  'pages_blocks_custom_block_burial_options_burial_badges',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('pages_blocks_custom_block_burial_options_burial_badges_order_idx').on(columns._order),
    index('pages_blocks_custom_block_burial_options_burial_badges_parent_id_idx').on(
      columns._parentID,
    ),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block_burial_options.id],
      name: 'pages_blocks_custom_block_burial_options_burial_badges_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_burial_options = pgTable(
  'pages_blocks_custom_block_burial_options',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    ...
    'burial-link': varchar('burial_link'),
    burialImage: integer('burial_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
  },
  (columns) => [
    index('pages_blocks_custom_block_burial_options_order_idx').on(columns._order),
    index('pages_blocks_custom_block_burial_options_parent_id_idx').on(columns._parentID),
    index('pages_blocks_custom_block_burial_options_burial_image_idx').on(columns.burialImage),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_burial_options_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_burial_options_list = pgTable(
  'pages_blocks_custom_block_burial_options_list',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('pages_blocks_custom_block_burial_options_list_order_idx').on(columns._order),
    index('pages_blocks_custom_block_burial_options_list_parent_id_idx').on(columns._parentID),
    index('pages_blocks_custom_block_burial_options_list_image_idx').on(columns.image),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_burial_options_list_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_stats_column = pgTable(
  'pages_blocks_custom_block_stats_column',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    statsValue: varchar('stats_value'),
    statsLabel: varchar('stats_label'),
  },
  (columns) => [
    index('pages_blocks_custom_block_stats_column_order_idx').on(columns._order),
    index('pages_blocks_custom_block_stats_column_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_stats_column_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_badges = pgTable(
  'pages_blocks_custom_block_badges',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    badgeLabel: varchar('badge_label'),
    badgeLink: varchar('badge_link'),
  },
  (columns) => [
    index('pages_blocks_custom_block_badges_order_idx').on(columns._order),
    index('pages_blocks_custom_block_badges_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_badges_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_support_cards = pgTable(
  'pages_blocks_custom_block_support_cards',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    supportTitle: jsonb('support_title'),
    supportDescription: varchar('support_description'),
    supportButtonText: varchar('support_button_text'),
    supportLink: varchar('support_link'),
  },
  (columns) => [
    index('pages_blocks_custom_block_support_cards_order_idx').on(columns._order),
    index('pages_blocks_custom_block_support_cards_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_support_cards_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_resources_links = pgTable(
  'pages_blocks_custom_block_resources_links',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    resourceTitle: varchar('resource_title'),
    resourceUrl: varchar('resource_url'),
    resourceDescription: varchar('resource_description'),
  },
  (columns) => [
    index('pages_blocks_custom_block_resources_links_order_idx').on(columns._order),
    index('pages_blocks_custom_block_resources_links_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_resources_links_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_contact_links = pgTable(
  'pages_blocks_custom_block_contact_links',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    ...
    linkVariant: enum_pages_blocks_custom_block_contact_links_link_variant('link_variant'),
  },
  (columns) => [
    index('pages_blocks_custom_block_contact_links_order_idx').on(columns._order),
    index('pages_blocks_custom_block_contact_links_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_contact_links_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_benefits = pgTable(
  'pages_blocks_custom_block_benefits',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('pages_blocks_custom_block_benefits_order_idx').on(columns._order),
    index('pages_blocks_custom_block_benefits_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_benefits_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_planning_process_cards = pgTable(
  'pages_blocks_custom_block_planning_process_cards',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('pages_blocks_custom_block_planning_process_cards_order_idx').on(columns._order),
    index('pages_blocks_custom_block_planning_process_cards_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_planning_process_cards_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block_faqs = pgTable(
  'pages_blocks_custom_block_faqs',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    faqQuestion: varchar('faq_question'),
    faqAnswer: varchar('faq_answer'),
  },
  (columns) => [
    index('pages_blocks_custom_block_faqs_order_idx').on(columns._order),
    index('pages_blocks_custom_block_faqs_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_custom_block.id],
      name: 'pages_blocks_custom_block_faqs_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_custom_block = pgTable(
  'pages_blocks_custom_block',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    section: enum_pages_blocks_custom_block_section('section').default('default'),
    heading: jsonb('heading'),
    body: jsonb('body'),
    signatureName: varchar('signature_name'),
    signatureTitle: varchar('signature_title'),
    signatureImage: integer('signature_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    planningLayout:
      enum_pages_blocks_custom_block_planning_layout('planning_layout').default('floral'),
    planningTitle: jsonb('planning_title'),
    description: varchar('description'),
    sectionTitle: jsonb('section_title'),
    burialLayout: enum_pages_blocks_custom_block_burial_layout('burial_layout').default('vertical'),
    burialDescription: varchar('burial_description'),
    image: integer('image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    statsTitle: jsonb('stats_title'),
    statsDescription: varchar('stats_description'),
    griefTitle: jsonb('grief_title'),
    griefSubtitle: varchar('grief_subtitle'),
    badgeText: varchar('badge_text'),
    guideTitle: jsonb('guide_title'),
    guideDescription: varchar('guide_description'),
    resourceTitle: jsonb('resource_title'),
    contactTitle: jsonb('contact_title'),
    contactDescription: varchar('contact_description'),
    benefitTitle: jsonb('benefit_title'),
    benefitLayout:
      enum_pages_blocks_custom_block_benefit_layout('benefit_layout').default('vertical'),
    benefitDescription: varchar('benefit_description'),
    testimonialText: varchar('testimonial_text'),
    testimonialAuthor: varchar('testimonial_author'),
    testimonialPlace: varchar('testimonial_place'),
    planningProcessTitle: jsonb('planning_process_title'),
    planningProcessDescription: varchar('planning_process_description'),
    faqRichTitle: jsonb('faq_rich_title'),
    blockName: varchar('block_name'),
  },
  (columns) => [
    index('pages_blocks_custom_block_order_idx').on(columns._order),
    index('pages_blocks_custom_block_parent_id_idx').on(columns._parentID),
    index('pages_blocks_custom_block_path_idx').on(columns._path),
    index('pages_blocks_custom_block_signature_image_idx').on(columns.signatureImage),
    index('pages_blocks_custom_block_image_idx').on(columns.image),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_custom_block_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const _pages_v_blocks_custom_block_columns = pgTable(
  '_pages_v_blocks_custom_block_columns',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    size: enum__pages_v_blocks_custom_block_columns_size('size').default('oneThird'),
    richText: jsonb('rich_text'),
    enableLink: boolean('enable_link'),
    _uuid: varchar('_uuid'),
  },
  (columns) => [
    index('_pages_v_blocks_custom_block_columns_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_columns_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_columns_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_planning_cards_badges = pgTable(
  '_pages_v_blocks_custom_block_planning_cards_badges',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_planning_cards_badges_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_planning_cards_badges_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block_planning_cards.id],
      name: '_pages_v_blocks_custom_block_planning_cards_badges_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_planning_cards = pgTable(
  '_pages_v_blocks_custom_block_planning_cards',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    ...
    buttonLabel: varchar('button_label'),
    buttonVariant:
      enum__pages_v_blocks_custom_block_planning_cards_button_variant('button_variant').default(
        'default',
      ),
    cardBackground: card_bg('card_background').default('default'),
    _uuid: varchar('_uuid'),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_planning_cards_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_planning_cards_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_planning_cards_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_burial_options_burial_badges = pgTable(
  '_pages_v_blocks_custom_block_burial_options_burial_badges',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_burial_options_burial_badges_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_burial_options_burial_badges_parent_id_idx').on(
      columns._parentID,
    ),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block_burial_options.id],
      name: '_pages_v_blocks_custom_block_burial_options_burial_badges_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_burial_options = pgTable(
  '_pages_v_blocks_custom_block_burial_options',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_burial_options_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_burial_options_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_custom_block_burial_options_burial_image_idx').on(columns.burialImage),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_burial_options_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_burial_options_list = pgTable(
  '_pages_v_blocks_custom_block_burial_options_list',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_burial_options_list_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_burial_options_list_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_custom_block_burial_options_list_image_idx').on(columns.image),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_burial_options_list_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_stats_column = pgTable(
  '_pages_v_blocks_custom_block_stats_column',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_stats_column_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_stats_column_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_stats_column_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_badges = pgTable(
  '_pages_v_blocks_custom_block_badges',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_badges_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_badges_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_badges_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_support_cards = pgTable(
  '_pages_v_blocks_custom_block_support_cards',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_support_cards_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_support_cards_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_support_cards_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_resources_links = pgTable(
  '_pages_v_blocks_custom_block_resources_links',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_resources_links_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_resources_links_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_resources_links_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_contact_links = pgTable(
  '_pages_v_blocks_custom_block_contact_links',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    linkTitle: varchar('link_title'),
    linkUrl: varchar('link_url'),
    linkVariant: enum__pages_v_blocks_custom_block_contact_links_link_variant('link_variant'),
    _uuid: varchar('_uuid'),
  },
  (columns) => [
    index('_pages_v_blocks_custom_block_contact_links_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_contact_links_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_contact_links_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_benefits = pgTable(
  '_pages_v_blocks_custom_block_benefits',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_benefits_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_benefits_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_benefits_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_planning_process_cards = pgTable(
  '_pages_v_blocks_custom_block_planning_process_cards',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_planning_process_cards_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_planning_process_cards_parent_id_idx').on(
      columns._parentID,
    ),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_planning_process_cards_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block_faqs = pgTable(
  '_pages_v_blocks_custom_block_faqs',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_faqs_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_faqs_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_custom_block.id],
      name: '_pages_v_blocks_custom_block_faqs_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_custom_block = pgTable(
  '_pages_v_blocks_custom_block',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: serial('id').primaryKey(),
    section: enum__pages_v_blocks_custom_block_section('section').default('default'),
    heading: jsonb('heading'),
    body: jsonb('body'),
    signatureName: varchar('signature_name'),
    signatureTitle: varchar('signature_title'),
    ...
    planningLayout:
      enum__pages_v_blocks_custom_block_planning_layout('planning_layout').default('floral'),
    planningTitle: jsonb('planning_title'),
    description: varchar('description'),
    sectionTitle: jsonb('section_title'),
    burialLayout:
      enum__pages_v_blocks_custom_block_burial_layout('burial_layout').default('vertical'),
    burialDescription: varchar('burial_description'),
    image: integer('image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    ...
    benefitTitle: jsonb('benefit_title'),
    benefitLayout:
      enum__pages_v_blocks_custom_block_benefit_layout('benefit_layout').default('vertical'),
    benefitDescription: varchar('benefit_description'),
    testimonialText: varchar('testimonial_text'),
    testimonialAuthor: varchar('testimonial_author'),
    testimonialPlace: varchar('testimonial_place'),
  ...
  (columns) => [
    index('_pages_v_blocks_custom_block_order_idx').on(columns._order),
    index('_pages_v_blocks_custom_block_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_custom_block_path_idx').on(columns._path),
    index('_pages_v_blocks_custom_block_signature_image_idx').on(columns.signatureImage),
    index('_pages_v_blocks_custom_block_image_idx').on(columns.image),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_custom_block_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const relations_pages_blocks_custom_block_columns = relations(
  pages_blocks_custom_block_columns,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_columns._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'columns',
    }),
  }),
)
export const relations_pages_blocks_custom_block_planning_cards_badges = relations(
  pages_blocks_custom_block_planning_cards_badges,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block_planning_cards, {
      fields: [pages_blocks_custom_block_planning_cards_badges._parentID],
      references: [pages_blocks_custom_block_planning_cards.id],
      relationName: 'badges',
    }),
  }),
)
export const relations_pages_blocks_custom_block_planning_cards = relations(
  pages_blocks_custom_block_planning_cards,
  ({ one, many }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_planning_cards._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'planningCards',
    }),
    badges: many(pages_blocks_custom_block_planning_cards_badges, {
      relationName: 'badges',
    }),
  }),
)
export const relations_pages_blocks_custom_block_burial_options_burial_badges = relations(
  pages_blocks_custom_block_burial_options_burial_badges,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block_burial_options, {
      fields: [pages_blocks_custom_block_burial_options_burial_badges._parentID],
      references: [pages_blocks_custom_block_burial_options.id],
      relationName: 'burialBadges',
    }),
  }),
)
export const relations_pages_blocks_custom_block_burial_options = relations(
  pages_blocks_custom_block_burial_options,
  ({ one, many }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_burial_options._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'burialOptions',
    }),
    burialImage: one(media, {
      fields: [pages_blocks_custom_block_burial_options.burialImage],
      references: [media.id],
      relationName: 'burialImage',
    }),
    burialBadges: many(pages_blocks_custom_block_burial_options_burial_badges, {
      relationName: 'burialBadges',
    }),
  }),
)
export const relations_pages_blocks_custom_block_burial_options_list = relations(
  pages_blocks_custom_block_burial_options_list,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_burial_options_list._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'burialOptionsList',
    }),
    image: one(media, {
      fields: [pages_blocks_custom_block_burial_options_list.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations_pages_blocks_custom_block_stats_column = relations(
  pages_blocks_custom_block_stats_column,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_stats_column._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'statsColumn',
    }),
  }),
)
export const relations_pages_blocks_custom_block_badges = relations(
  pages_blocks_custom_block_badges,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_badges._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'badges',
    }),
  }),
)
export const relations_pages_blocks_custom_block_support_cards = relations(
  pages_blocks_custom_block_support_cards,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_support_cards._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'supportCards',
    }),
  }),
)
export const relations_pages_blocks_custom_block_resources_links = relations(
  pages_blocks_custom_block_resources_links,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_resources_links._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'resourcesLinks',
    }),
  }),
)
export const relations_pages_blocks_custom_block_contact_links = relations(
  pages_blocks_custom_block_contact_links,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_contact_links._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'contactLinks',
    }),
  }),
)
export const relations_pages_blocks_custom_block_benefits = relations(
  pages_blocks_custom_block_benefits,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_benefits._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'benefits',
    }),
  }),
)
export const relations_pages_blocks_custom_block_planning_process_cards = relations(
  pages_blocks_custom_block_planning_process_cards,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_planning_process_cards._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'planningProcessCards',
    }),
  }),
)
export const relations_pages_blocks_custom_block_faqs = relations(
  pages_blocks_custom_block_faqs,
  ({ one }) => ({
    _parentID: one(pages_blocks_custom_block, {
      fields: [pages_blocks_custom_block_faqs._parentID],
      references: [pages_blocks_custom_block.id],
      relationName: 'faqs',
    }),
  }),
)
export const relations_pages_blocks_custom_block = relations(
  pages_blocks_custom_block,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_custom_block._parentID],
      references: [pages.id],
      relationName: '_blocks_customBlock',
    }),
    columns: many(pages_blocks_custom_block_columns, {
      relationName: 'columns',
    }),
    signatureImage: one(media, {
      fields: [pages_blocks_custom_block.signatureImage],
      references: [media.id],
      relationName: 'signatureImage',
    }),
    planningCards: many(pages_blocks_custom_block_planning_cards, {
      relationName: 'planningCards',
    }),
    image: one(media, {
      fields: [pages_blocks_custom_block.image],
      references: [media.id],
      relationName: 'image',
    }),
    burialOptions: many(pages_blocks_custom_block_burial_options, {
      relationName: 'burialOptions',
    }),
    burialOptionsList: many(pages_blocks_custom_block_burial_options_list, {
      relationName: 'burialOptionsList',
    }),
    statsColumn: many(pages_blocks_custom_block_stats_column, {
      relationName: 'statsColumn',
    }),
    badges: many(pages_blocks_custom_block_badges, {
      relationName: 'badges',
    }),
    supportCards: many(pages_blocks_custom_block_support_cards, {
      relationName: 'supportCards',
    }),
    resourcesLinks: many(pages_blocks_custom_block_resources_links, {
      relationName: 'resourcesLinks',
    }),
    contactLinks: many(pages_blocks_custom_block_contact_links, {
      relationName: 'contactLinks',
    }),
    benefits: many(pages_blocks_custom_block_benefits, {
      relationName: 'benefits',
    }),
    planningProcessCards: many(pages_blocks_custom_block_planning_process_cards, {
      relationName: 'planningProcessCards',
    }),
    faqs: many(pages_blocks_custom_block_faqs, {
      relationName: 'faqs',
    }),
  }),
)
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  _blocks_customBlock: many(pages_blocks_custom_block, {
    relationName: '_blocks_customBlock',
  }),
...
export const relations__pages_v_blocks_custom_block_columns = relations(
  _pages_v_blocks_custom_block_columns,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_columns._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'columns',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_planning_cards_badges = relations(
  _pages_v_blocks_custom_block_planning_cards_badges,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block_planning_cards, {
      fields: [_pages_v_blocks_custom_block_planning_cards_badges._parentID],
      references: [_pages_v_blocks_custom_block_planning_cards.id],
      relationName: 'badges',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_planning_cards = relations(
  _pages_v_blocks_custom_block_planning_cards,
  ({ one, many }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_planning_cards._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'planningCards',
    }),
    badges: many(_pages_v_blocks_custom_block_planning_cards_badges, {
      relationName: 'badges',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_burial_options_burial_badges = relations(
  _pages_v_blocks_custom_block_burial_options_burial_badges,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block_burial_options, {
      fields: [_pages_v_blocks_custom_block_burial_options_burial_badges._parentID],
      references: [_pages_v_blocks_custom_block_burial_options.id],
      relationName: 'burialBadges',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_burial_options = relations(
  _pages_v_blocks_custom_block_burial_options,
  ({ one, many }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_burial_options._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'burialOptions',
    }),
    burialImage: one(media, {
      fields: [_pages_v_blocks_custom_block_burial_options.burialImage],
      references: [media.id],
      relationName: 'burialImage',
    }),
    burialBadges: many(_pages_v_blocks_custom_block_burial_options_burial_badges, {
      relationName: 'burialBadges',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_burial_options_list = relations(
  _pages_v_blocks_custom_block_burial_options_list,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_burial_options_list._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'burialOptionsList',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_custom_block_burial_options_list.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_stats_column = relations(
  _pages_v_blocks_custom_block_stats_column,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_stats_column._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'statsColumn',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_badges = relations(
  _pages_v_blocks_custom_block_badges,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_badges._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'badges',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_support_cards = relations(
  _pages_v_blocks_custom_block_support_cards,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_support_cards._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'supportCards',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_resources_links = relations(
  _pages_v_blocks_custom_block_resources_links,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_resources_links._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'resourcesLinks',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_contact_links = relations(
  _pages_v_blocks_custom_block_contact_links,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_contact_links._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'contactLinks',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_benefits = relations(
  _pages_v_blocks_custom_block_benefits,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_benefits._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'benefits',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_planning_process_cards = relations(
  _pages_v_blocks_custom_block_planning_process_cards,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_planning_process_cards._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'planningProcessCards',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block_faqs = relations(
  _pages_v_blocks_custom_block_faqs,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_custom_block, {
      fields: [_pages_v_blocks_custom_block_faqs._parentID],
      references: [_pages_v_blocks_custom_block.id],
      relationName: 'faqs',
    }),
  }),
)
export const relations__pages_v_blocks_custom_block = relations(
  _pages_v_blocks_custom_block,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_custom_block._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_customBlock',
    }),
    columns: many(_pages_v_blocks_custom_block_columns, {
      relationName: 'columns',
    }),
    signatureImage: one(media, {
      fields: [_pages_v_blocks_custom_block.signatureImage],
      references: [media.id],
      relationName: 'signatureImage',
    }),
    planningCards: many(_pages_v_blocks_custom_block_planning_cards, {
      relationName: 'planningCards',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_custom_block.image],
      references: [media.id],
      relationName: 'image',
    }),
    burialOptions: many(_pages_v_blocks_custom_block_burial_options, {
      relationName: 'burialOptions',
    }),
    burialOptionsList: many(_pages_v_blocks_custom_block_burial_options_list, {
      relationName: 'burialOptionsList',
    }),
    statsColumn: many(_pages_v_blocks_custom_block_stats_column, {
      relationName: 'statsColumn',
    }),
    badges: many(_pages_v_blocks_custom_block_badges, {
      relationName: 'badges',
    }),
    supportCards: many(_pages_v_blocks_custom_block_support_cards, {
      relationName: 'supportCards',
    }),
    resourcesLinks: many(_pages_v_blocks_custom_block_resources_links, {
      relationName: 'resourcesLinks',
    }),
    contactLinks: many(_pages_v_blocks_custom_block_contact_links, {
      relationName: 'contactLinks',
    }),
    benefits: many(_pages_v_blocks_custom_block_benefits, {
      relationName: 'benefits',
    }),
    planningProcessCards: many(_pages_v_blocks_custom_block_planning_process_cards, {
      relationName: 'planningProcessCards',
    }),
    faqs: many(_pages_v_blocks_custom_block_faqs, {
      relationName: 'faqs',
    }),
  }),
)
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  _blocks_customBlock: many(_pages_v_blocks_custom_block, {
    relationName: '_blocks_customBlock',
  }),
...
type DatabaseSchema = {
  ...
  enum_pages_blocks_custom_block_columns_size: typeof enum_pages_blocks_custom_block_columns_size
  enum_pages_blocks_custom_block_planning_cards_button_variant: typeof enum_pages_blocks_custom_block_planning_cards_button_variant
  card_bg: typeof card_bg
  enum_pages_blocks_custom_block_contact_links_link_variant: typeof enum_pages_blocks_custom_block_contact_links_link_variant
  enum_pages_blocks_custom_block_section: typeof enum_pages_blocks_custom_block_section
  enum_pages_blocks_custom_block_planning_layout: typeof enum_pages_blocks_custom_block_planning_layout
  enum_pages_blocks_custom_block_burial_layout: typeof enum_pages_blocks_custom_block_burial_layout
  enum_pages_blocks_custom_block_benefit_layout: typeof enum_pages_blocks_custom_block_benefit_layout
  ...
  enum__pages_v_blocks_custom_block_columns_size: typeof enum__pages_v_blocks_custom_block_columns_size
  enum__pages_v_blocks_custom_block_planning_cards_button_variant: typeof enum__pages_v_blocks_custom_block_planning_cards_button_variant
  enum__pages_v_blocks_custom_block_contact_links_link_variant: typeof enum__pages_v_blocks_custom_block_contact_links_link_variant
  enum__pages_v_blocks_custom_block_section: typeof enum__pages_v_blocks_custom_block_section
  enum__pages_v_blocks_custom_block_planning_layout: typeof enum__pages_v_blocks_custom_block_planning_layout
  enum__pages_v_blocks_custom_block_burial_layout: typeof enum__pages_v_blocks_custom_block_burial_layout
  enum__pages_v_blocks_custom_block_benefit_layout: typeof enum__pages_v_blocks_custom_block_benefit_layout
  ...
  pages_blocks_custom_block_columns: typeof pages_blocks_custom_block_columns
  pages_blocks_custom_block_planning_cards_badges: typeof pages_blocks_custom_block_planning_cards_badges
  pages_blocks_custom_block_planning_cards: typeof pages_blocks_custom_block_planning_cards
  pages_blocks_custom_block_burial_options_burial_badges: typeof pages_blocks_custom_block_burial_options_burial_badges
  pages_blocks_custom_block_burial_options: typeof pages_blocks_custom_block_burial_options
  pages_blocks_custom_block_burial_options_list: typeof pages_blocks_custom_block_burial_options_list
  pages_blocks_custom_block_stats_column: typeof pages_blocks_custom_block_stats_column
  pages_blocks_custom_block_badges: typeof pages_blocks_custom_block_badges
  pages_blocks_custom_block_support_cards: typeof pages_blocks_custom_block_support_cards
  pages_blocks_custom_block_resources_links: typeof pages_blocks_custom_block_resources_links
  pages_blocks_custom_block_contact_links: typeof pages_blocks_custom_block_contact_links
  pages_blocks_custom_block_benefits: typeof pages_blocks_custom_block_benefits
  pages_blocks_custom_block_planning_process_cards: typeof pages_blocks_custom_block_planning_process_cards
  pages_blocks_custom_block_faqs: typeof pages_blocks_custom_block_faqs
  pages_blocks_custom_block: typeof pages_blocks_custom_block
  pages: typeof pages
  ...
  _pages_v_blocks_custom_block_columns: typeof _pages_v_blocks_custom_block_columns
  _pages_v_blocks_custom_block_planning_cards_badges: typeof _pages_v_blocks_custom_block_planning_cards_badges
  _pages_v_blocks_custom_block_planning_cards: typeof _pages_v_blocks_custom_block_planning_cards
  _pages_v_blocks_custom_block_burial_options_burial_badges: typeof _pages_v_blocks_custom_block_burial_options_burial_badges
  _pages_v_blocks_custom_block_burial_options: typeof _pages_v_blocks_custom_block_burial_options
  _pages_v_blocks_custom_block_burial_options_list: typeof _pages_v_blocks_custom_block_burial_options_list
  _pages_v_blocks_custom_block_stats_column: typeof _pages_v_blocks_custom_block_stats_column
  _pages_v_blocks_custom_block_badges: typeof _pages_v_blocks_custom_block_badges
  _pages_v_blocks_custom_block_support_cards: typeof _pages_v_blocks_custom_block_support_cards
  _pages_v_blocks_custom_block_resources_links: typeof _pages_v_blocks_custom_block_resources_links
  _pages_v_blocks_custom_block_contact_links: typeof _pages_v_blocks_custom_block_contact_links
  _pages_v_blocks_custom_block_benefits: typeof _pages_v_blocks_custom_block_benefits
  _pages_v_blocks_custom_block_planning_process_cards: typeof _pages_v_blocks_custom_block_planning_process_cards
  _pages_v_blocks_custom_block_faqs: typeof _pages_v_blocks_custom_block_faqs
  _pages_v_blocks_custom_block: typeof _pages_v_blocks_custom_block
  ...
  relations_pages_blocks_custom_block_columns: typeof relations_pages_blocks_custom_block_columns
  relations_pages_blocks_custom_block_planning_cards_badges: typeof relations_pages_blocks_custom_block_planning_cards_badges
  relations_pages_blocks_custom_block_planning_cards: typeof relations_pages_blocks_custom_block_planning_cards
  relations_pages_blocks_custom_block_burial_options_burial_badges: typeof relations_pages_blocks_custom_block_burial_options_burial_badges
  relations_pages_blocks_custom_block_burial_options: typeof relations_pages_blocks_custom_block_burial_options
  relations_pages_blocks_custom_block_burial_options_list: typeof relations_pages_blocks_custom_block_burial_options_list
  relations_pages_blocks_custom_block_stats_column: typeof relations_pages_blocks_custom_block_stats_column
  relations_pages_blocks_custom_block_badges: typeof relations_pages_blocks_custom_block_badges
  relations_pages_blocks_custom_block_support_cards: typeof relations_pages_blocks_custom_block_support_cards
  relations_pages_blocks_custom_block_resources_links: typeof relations_pages_blocks_custom_block_resources_links
  relations_pages_blocks_custom_block_contact_links: typeof relations_pages_blocks_custom_block_contact_links
  relations_pages_blocks_custom_block_benefits: typeof relations_pages_blocks_custom_block_benefits
  relations_pages_blocks_custom_block_planning_process_cards: typeof relations_pages_blocks_custom_block_planning_process_cards
  relations_pages_blocks_custom_block_faqs: typeof relations_pages_blocks_custom_block_faqs
  relations_pages_blocks_custom_block: typeof relations_pages_blocks_custom_block
  ...
  relations__pages_v_blocks_custom_block_columns: typeof relations__pages_v_blocks_custom_block_columns
  relations__pages_v_blocks_custom_block_planning_cards_badges: typeof relations__pages_v_blocks_custom_block_planning_cards_badges
  relations__pages_v_blocks_custom_block_planning_cards: typeof relations__pages_v_blocks_custom_block_planning_cards
  relations__pages_v_blocks_custom_block_burial_options_burial_badges: typeof relations__pages_v_blocks_custom_block_burial_options_burial_badges
  relations__pages_v_blocks_custom_block_burial_options: typeof relations__pages_v_blocks_custom_block_burial_options
  relations__pages_v_blocks_custom_block_burial_options_list: typeof relations__pages_v_blocks_custom_block_burial_options_list
  relations__pages_v_blocks_custom_block_stats_column: typeof relations__pages_v_blocks_custom_block_stats_column
  relations__pages_v_blocks_custom_block_badges: typeof relations__pages_v_blocks_custom_block_badges
  relations__pages_v_blocks_custom_block_support_cards: typeof relations__pages_v_blocks_custom_block_support_cards
  relations__pages_v_blocks_custom_block_resources_links: typeof relations__pages_v_blocks_custom_block_resources_links
  relations__pages_v_blocks_custom_block_contact_links: typeof relations__pages_v_blocks_custom_block_contact_links
  relations__pages_v_blocks_custom_block_benefits: typeof relations__pages_v_blocks_custom_block_benefits
  relations__pages_v_blocks_custom_block_planning_process_cards: typeof relations__pages_v_blocks_custom_block_planning_process_cards
  relations__pages_v_blocks_custom_block_faqs: typeof relations__pages_v_blocks_custom_block_faqs
  relations__pages_v_blocks_custom_block: typeof relations__pages_v_blocks_custom_block
