                ...
                <div className="grid gap-12">
                    {burialOptionsList.map((option, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className={cn("p-3 border border-primary-dark bg-background-light rounded-lg", isOdd ? 'lg:order-2' : 'lg:order-1')}>
                                    <Image
                                ...
                                <div className={cn("p-6 flex flex-col justify-between", isOdd ? 'lg:order-1' : 'lg:order-2')}>
                                    <div>
                                        <h3 className="text-4xl font-semibold mb-3 text-brand-10">
                                            {option.title}
                                        </h3>
                                        {option.category && (
